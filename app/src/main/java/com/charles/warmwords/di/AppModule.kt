...
import com.charles.warmwords.data.local.WarmWordDatabase
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindJournalRepository(impl: com.charles.warmwords.data.repository.JournalRepositoryImpl): com.charles.warmwords.domain.repository.JournalRepository

    @Binds
    @Singleton
    abstract fun bindMoodRepository(impl: com.charles.warmwords.data.repository.MoodRepositoryImpl): com.charles.warmwords.domain.repository.MoodRepository

    @Binds
    @Singleton
    abstract fun bindChatRepository(impl: com.charles.warmwords.data.repository.ChatRepositoryImpl): com.charles.warmwords.domain.repository.ChatRepository

    @Binds
    @Singleton
    abstract fun bindUserProfileRepository(impl: com.charles.warmwords.data.repository.UserProfileRepositoryImpl): com.charles.warmwords.domain.repository.UserProfileRepository

    @Binds
    @Singleton
    abstract fun bindSessionReminderRepository(impl: com.charles.warmwords.data.repository.SessionReminderRepositoryImpl): com.charles.warmwords.domain.repository.SessionReminderRepository

    @Binds
    @Singleton
    abstract fun bindSessionNoteRepository(impl: com.charles.warmwords.data.repository.SessionNoteRepositoryImpl): com.charles.warmwords.domain.repository.SessionNoteRepository
}
