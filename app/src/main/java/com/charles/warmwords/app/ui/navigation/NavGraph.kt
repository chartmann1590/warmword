package com.charles.warmwords.app.ui.navigation
...
import com.charles.warmwords.app.ui.screens.chat.ChatScreen
import com.charles.warmwords.app.ui.screens.findhelp.FindHelpScreen
import com.charles.warmwords.app.ui.screens.insights.InsightsScreen
...
fun WarmWordNavGraph(
    ...
    NavHost(
        ...
        composable(Screen.Chat.route) {
            val chatViewModel: com.charles.warmwords.app.ui.screens.chat.ChatViewModel = hiltViewModel()
            ChatScreen(
        ...
        composable(Screen.Journal.route) {
            val journalViewModel: com.charles.warmwords.app.ui.screens.journal.JournalViewModel = hiltViewModel()
            JournalScreen(viewModel = journalViewModel)
        }

        composable(Screen.Insights.route) {
            val insightsViewModel: com.charles.warmwords.app.ui.screens.insights.InsightsViewModel = hiltViewModel()
            InsightsScreen(viewModel = insightsViewModel)
        }

        composable(Screen.FindHelp.route) {
            val findHelpViewModel: com.charles.warmwords.app.ui.screens.findhelp.FindHelpViewModel = hiltViewModel()
